    ...
    private void horizontalSpin() {
        element.appendChild(Card.create("HORIZONTAL SPIN")
                .appendChild(Row.create()
                        ...
                        .appendChild(Column.span2()
                                .appendChild(HSpinSelect.<String>create()
                                        .appendChild(SpinItem.create("item 1", div().css("sample-spin-item").add(Icons.ALL.battery_charging_100_mdi())))
                                        .appendChild(SpinItem.create("item 2", div().css("sample-spin-item").add(Icons.ALL.bluetooth_mdi())))
                                        .appendChild(SpinItem.create("item 3", div().css("sample-spin-item").add(Icons.ALL.database_mdi())))
                                        .appendChild(SpinItem.create("item 4", div().css("sample-spin-item").add(Icons.ALL.brightness_4_mdi())))
                                        .appendChild(SpinItem.create("item 5", div().css("sample-spin-item").add(Icons.ALL.devices_mdi())))
                                        .appendChild(SpinItem.create("item 6", div().css("sample-spin-item").add(Icons.ALL.crosshairs_gps_mdi())))
                                        .appendChild(SpinItem.create("item 7", div().css("sample-spin-item").add(Icons.ALL.graph_mdi())))
                                        .appendChild(SpinItem.create("item 8", div().css("sample-spin-item").add(Icons.ALL.search_web_mdi())))
                                        .appendChild(SpinItem.create("item 9", div().css("sample-spin-item").add(Icons.ALL.alarm_mdi())))
                                        .appendChild(SpinItem.create("item 10", div().css("sample-spin-item").add(Icons.ALL.airplay_mdi())))
                                ))
                        .appendChild(Column.span2()
                                .appendChild(HSpinSelect.<String>create()
                        ...
                        .appendChild(Column.span6()
                                .appendChild(HSpinSelect.<String>create(Icons.ALL.menu_left_mdi(), Icons.ALL.menu_right_mdi())
        ...
        element.appendChild(Card.create("VERTICAL SPIN", "For vertical spins to work the height should be fixed.")
                .appendChild(Row.create()
                        ...
                        .appendChild(Column.span2()
                                .appendChild(VSpinSelect.<String>create()
                                        .setHeight("50px")
                                        .appendChild(SpinItem.create("item 1", div().css("sample-spin-item").add(Icons.ALL.battery_charging_100_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 2", div().css("sample-spin-item").add(Icons.ALL.bluetooth_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 3", div().css("sample-spin-item").add(Icons.ALL.database_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 4", div().css("sample-spin-item").add(Icons.ALL.brightness_4_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 5", div().css("sample-spin-item").add(Icons.ALL.devices_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 6", div().css("sample-spin-item").add(Icons.ALL.crosshairs_gps_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 7", div().css("sample-spin-item").add(Icons.ALL.graph_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 8", div().css("sample-spin-item").add(Icons.ALL.search_web_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 9", div().css("sample-spin-item").add(Icons.ALL.alarm_mdi().style().addCss(Styles.vertical_center))))
                                        .appendChild(SpinItem.create("item 10", div().css("sample-spin-item").add(Icons.ALL.airplay_mdi().style().addCss(Styles.vertical_center))))
                                ))
                        .appendChild(Column.span2()
                                .appendChild(VSpinSelect.<String>create()
                                        .setHeight("50px")
                        ...
                        .appendChild(Column.span6()
                                .appendChild(VSpinSelect.<String>create(Icons.ALL.menu_up_mdi(), Icons.ALL.menu_up_mdi())
                                        .setHeight("50px")
                                        .appendChild(SpinItem.create("item 1", div().css("sample-spin-item").add(TextNode.of("Cras justo odio"))))
                                        .appendChild(SpinItem.create("item 2", div().css("sample-spin-item").add(TextNode.of("Dapibus ac facilisis in"))))
                                        .appendChild(SpinItem.create("item 3", div().css("sample-spin-item").add(TextNode.of("Morbi leo risus"))))
