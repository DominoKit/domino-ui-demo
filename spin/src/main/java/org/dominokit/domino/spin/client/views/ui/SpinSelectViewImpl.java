    ...
    private void horizontalSpin() {
        element.appendChild(Card.create("HORIZONTAL SPIN")
                .appendChild(Row.create()
                        ...
                        .appendChild(Column.span2()
                                .appendChild(HSpinSelect.<String>create()
                                        .appendChild(SpinItem.create("item 1", div().css("sample-spin-item").add(Icons.ALL.battery_90_mdi().style())))
                                        .appendChild(SpinItem.create("item 2", div().css("sample-spin-item").add(Icons.ALL.bluetooth_mdi().style())))
                                        .appendChild(SpinItem.create("item 3", div().css("sample-spin-item").add(Icons.ALL.database_mdi().style())))
                                        .appendChild(SpinItem.create("item 4", div().css("sample-spin-item").add(Icons.ALL.brightness_5_mdi().style())))
                                        .appendChild(SpinItem.create("item 5", div().css("sample-spin-item").add(Icons.ALL.devices_mdi().style())))
                                        .appendChild(SpinItem.create("item 6", div().css("sample-spin-item").add(Icons.ALL.crosshairs_gps_mdi().style())))
                                        .appendChild(SpinItem.create("item 7", div().css("sample-spin-item").add(Icons.ALL.graph_mdi().style())))
                                        .appendChild(SpinItem.create("item 8", div().css("sample-spin-item").add(Icons.ALL.location_enter_mdi().style())))
                                        .appendChild(SpinItem.create("item 9", div().css("sample-spin-item").add(Icons.ALL.access_point_mdi().style())))
                                        .appendChild(SpinItem.create("item 10", div().css("sample-spin-item").add(Icons.ALL.airplane_off_mdi().style())))
                                ))
                        .appendChild(Column.span2()
                                .appendChild(HSpinSelect.<String>create()
