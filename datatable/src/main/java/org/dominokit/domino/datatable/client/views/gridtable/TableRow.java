 ...
 */
public class TableRow<T> extends BaseDominoElement<HTMLDivElement, TableRow<T>>
  ...
  public void renderCell(ColumnConfig<T> columnConfig) {
    DivElement cellElement = div().addCss(dui_datatable_td);
    ...
    columnConfig.applyCellStyle(cellElement.element());
