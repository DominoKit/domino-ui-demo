...
import org.dominokit.domino.datatable.client.presenters.BasicDatatableProxy;
...
import org.dominokit.domino.ui.datatable.plugins.row.RowHighlightPlugin;
...
public class BasicDataTableViewImpl extends BaseDemoView<HTMLDivElement> implements DatatableView {
    ...
    private void basicTable() {
        ...
        tableConfig
                .addColumn(ColumnConfig.<Contact>create("id", "#")
                        ...
                        .onCellReady(target ->target.setCssProperty("padding-left", "10px"))
                ...
                .addPlugin(new RowHighlightPlugin<>())
