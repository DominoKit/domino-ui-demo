...
//        );
        ...
        summaryPlugin();
        element.appendChild(CodeCard.createLazyCodeCard(CodeResource.INSTANCE.summaryPlugin()).element());
...
//                        .setWidth("600px")
//                )
//                .addPlugin(new ResizeColumnsPlugin<Car>().configure(config -> config.setClipContent(false)))
...
//                .apply(self -> {
//                    self
//                            .appendChild(Button.create("remove").addClickListener(evt -> dataTable.remove()))
//                            .appendChild(Button.create("add").addClickListener(evt -> self.appendChild(dataTable)));
//                })
//
...
//    }
    ...
    private void resizableColumns() {
        ...
        contactListParseHandlers.add(contacts -> {
            localListDataStore.setData(subList(contacts, 100));
        });
    }
