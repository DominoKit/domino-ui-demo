    ...
    private void benchmarkText() {
        ...
        tableConfig
                .addColumn(ColumnConfig.<DemoContact>create("id", "#")
                        ...
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getId() + 1 + ""))
                )
                .addColumn(ColumnConfig.<DemoContact>create("isActive", "Active")
                        ...
                        .setCellRenderer(cell -> text(String.valueOf(cell.getTableRow().getRecord().isActive())))
                )
                .addColumn(ColumnConfig.<DemoContact>create("firstName", "First Name")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getFirstName()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("lastName", "Last Name")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getLastName()))
                )
                ...
                .addColumn(ColumnConfig.<DemoContact>create("address", "Address")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getAddress()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("city", "City")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getCity()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("state", "State")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getState()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("zipCode", "ZIP Code")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getZipCode()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("country", "Country")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getCountry()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("birthDate", "Birth Date")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getBirthDate().toString()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("company", "Company")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getCompany()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("jobTitle", "Job title")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getJobTitle()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("department", "Department")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getDepartment()))
                )
                ...
                .addColumn(ColumnConfig.<DemoContact>create("twitterHandle", "Twitter Handle")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getTwitterHandle()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("facebookId", "Facebook Id")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getFacebookId()))
                )
                ...
                .addColumn(ColumnConfig.<DemoContact>create("createdAt", "Created At")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(new Date(cell.getTableRow().getRecord().getCreatedAt()).toString()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("updatedAt", "Updated At")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(new Date(cell.getTableRow().getRecord().getUpdatedAt()).toString()))
                )

                .addColumn(ColumnConfig.<DemoContact>create("rating", "Rating")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(String.valueOf(cell.getTableRow().getRecord().getRating())))
                )
                .addColumn(ColumnConfig.<DemoContact>create("customField1", "Custom Field-1")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getCustomField1()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("customField2", "Custom Field-2")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(String.valueOf(cell.getTableRow().getRecord().getCustomField2())))
                )
        ;
    ...
    private void benchmarkWidgets() {
        ...
        tableConfig
                ...
                .addColumn(ColumnConfig.<DemoContact>create("isActive", "Active")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> CheckBox.create()
                ...
                .addColumn(ColumnConfig.<DemoContact>create("email", "Email")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> a().textContent(cell.getTableRow().getRecord().getEmail()).setHref(cell.getTableRow().getRecord().getEmail()).element())
                )
                .addColumn(ColumnConfig.<DemoContact>create("rating", "Rating")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> Select.<Double>create()
                                .addCss(dui_hide_label)
                ...
                .addColumn(ColumnConfig.<DemoContact>create("website", "Website")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> a().textContent(cell.getTableRow().getRecord().getWebsite()).setHref(cell.getTableRow().getRecord().getWebsite()).element())
                )
                .addColumn(ColumnConfig.<DemoContact>create("twitterHandle", "Twitter Handle")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> a().textContent(cell.getTableRow().getRecord().getTwitterHandle()).setHref(cell.getTableRow().getRecord().getTwitterHandle()).element())
                )
                .addColumn(ColumnConfig.<DemoContact>create("facebookId", "Facebook Id")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> a().textContent(cell.getTableRow().getRecord().getFacebookId()).setHref(cell.getTableRow().getRecord().getFacebookId()).element())
                )
                .addColumn(ColumnConfig.<DemoContact>create("linkedinProfile", "Linked-in Profile")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> a().textContent(cell.getTableRow().getRecord().getLinkedinProfile()).setHref(cell.getTableRow().getRecord().getLinkedinProfile()).element())
                )
                .addColumn(ColumnConfig.<DemoContact>create("phone", "Phone")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                ...
                .addColumn(ColumnConfig.<DemoContact>create("notes", "Notes")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> text(cell.getTableRow().getRecord().getNotes()))
                )
                .addColumn(ColumnConfig.<DemoContact>create("createdAt", "Created At")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                ...
                .addColumn(ColumnConfig.<DemoContact>create("customField1", "Custom Field-1")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> TextBox.create().addCss(dui_hide_label).withValue(cell.getTableRow().getRecord().getCustomField1()).element())
                )
                .addColumn(ColumnConfig.<DemoContact>create("customField2", "Custom Field-2")
                        .setTextAlign(CellTextAlign.LEFT)
                        .setHeaderTextAlign(CellTextAlign.LEFT)
                        .setCellRenderer(cell -> IntegerBox.create().addCss(dui_hide_label).withValue(cell.getTableRow().getRecord().getCustomField2()).element())
                )
        ;
