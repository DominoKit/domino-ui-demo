...
public class AlertsViewImpl extends ComponentView<HTMLDivElement> implements AlertsView {
    ...
    private void basicAlerts() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.basicAlerts()).asElement());
    }
    ...
    private void customBackground() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.customBackgrounds())
                .asElement());
    ...
    private void dismissibleAlerts() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.dismissibleAlerts()).asElement());
    }
    ...
    private void linksInAlerts() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.linksInAlerts()).asElement());
    }
}