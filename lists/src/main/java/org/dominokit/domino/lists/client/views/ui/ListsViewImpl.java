...
public class ListsViewImpl extends ComponentView<HTMLDivElement> implements ListsView {
    ...
    private void basicListsSample() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.basicListsSample())
                .asElement());
    }
    ...
    private void selectableSample() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.selectableSample())
                .asElement());
    }
    ...
    private void coloredSample() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.coloredSample())
                .asElement());
    }
    ...
    private void richItems() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.richItems())
                .asElement());
    }
}