...
public class ModalsViewImpl extends ComponentView<HTMLDivElement> implements ModalsView {
    ...
    private void initModalsSize() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.initModalsSize())
                .asElement());
    }
    ...
    private void initModalColor() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.initModalColor()).asElement());
