...
public class RightUpDropDirection implements DropDown.ElementPosition {
    @Override
    public void position(HTMLElement source, HTMLElement target) {
        ...
        source.style.setProperty(
                "top", px.of((targetRect.top + window.pageYOffset) - (sourceRect.height - targetRect.height)+ delta));
