...
import org.dominokit.domino.ui.button.SplitButton;
...
public class ButtonsViewImpl extends BaseDemoView<HTMLDivElement> implements ButtonsView {
    ...
    private void initSingleDropdownButtons() {
        element.appendChild(Card.create("SINGLE BUTTON DROPDOWNS", "Turn a button into a dropdown toggle with some basic markup changes.")
                ...
                .appendChild(DropdownButton.createDanger("DANGER")
                        ...
                        .appendChild(DropdownAction.create("Separated link"))
                        .style().setMargin(px.of(5)))
                .appendChild(DropdownButton.create(Icons.ALL.delete_mdi())
                        .appendChild(DropdownAction.create("Action"))
                        .appendChild(DropdownAction.create("Another action"))
                        .appendChild(DropdownAction.create("Something else here"))
                        .separator()
        ...
        element.appendChild(Card.create("SIZING", "Instead of applying button sizing classes to every button in a group, size can be applied to the group and will be applied to every button.")
                .appendChild(Row.create()
                        .addColumn(Column.span3()
                                .style().addCss(Styles.align_center).get()
    ...
    private void initTextButtons() {
        element.appendChild(Card.create("ICON & TEXT BUTTONS", "Make icon & text buttons")
                .appendChild(Button.create(Icons.ALL.widgets_mdi())
                ...
                .appendChild(Button.create(Icons.ALL.home_mdi())
                        ...
                        .setMargin(px.of(5))
                        .setMinWidth(px.of(120)))
                .appendChild(Button.createPrimary(Icons.ALL.home_mdi())
                        .setContent("HOME")
                        .style()
                        .setMargin(px.of(5))
                        .setMinWidth(px.of(120)))
                .appendChild(Button.createSuccess(Icons.ALL.lock_mdi())
                        .setContent("LOCK")
                        .style()
                        .setMargin(px.of(5))
                        .setMinWidth(px.of(120)))
                .appendChild(Button.createInfo(Icons.ALL.wifi_mdi())
                        .setContent("SCAN WIFI")
                        .style()
                        .setMargin(px.of(5))
                        .setMinWidth(px.of(120)))
                .appendChild(Button.createWarning(Icons.ALL.airplane_takeoff_mdi())
                        .setContent("TAKE OFF")
                        .style()
                        .setMargin(px.of(5))
                        .setMinWidth(px.of(120)))
                .appendChild(Button.createDanger(Icons.ALL.printer_mdi())
                        .setContent("PRINT")
                        .style()
                        .setMargin(px.of(5))
                        .setMinWidth(px.of(120)))
    ...
    private void initButtons() {
        element.appendChild(Card.create("ICON BUTTONS", "Make icon buttons")
                ...
                .appendChild(Row.create()
                        ...
                        .addColumn(Column.span1()
                                .appendChild(Button.create(Icons.ALL.home_mdi())
                                        ...
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createPrimary(Icons.ALL.microphone_mdi())
                                        .setButtonType(StyleType.PRIMARY)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createInfo(Icons.ALL.more_mdi())
                                        .setButtonType(StyleType.INFO)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createSuccess(Icons.ALL.keyboard_mdi())
                                        .setButtonType(StyleType.SUCCESS)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createWarning(Icons.ALL.air_conditioner_mdi())
                                        .setButtonType(StyleType.WARNING)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createDanger(Icons.ALL.alarm_mdi())
                ...
                .appendChild(Row.create()
                        .addColumn(Column.span1()
                                .appendChild(Button.create(Icons.ALL.circle_mdi())
                                        .circle()
                                        .setSize(ButtonSize.SMALL)
                                        .setButtonType(StyleType.DEFAULT)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createPrimary(Icons.ALL.select_place_mdi())
                                        .circle()
                                        .setSize(ButtonSize.SMALL)
                                        .setButtonType(StyleType.PRIMARY)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createInfo(Icons.ALL.airplane_off_mdi())
                                        .circle()
                                        .setSize(ButtonSize.SMALL)
                                        .setButtonType(StyleType.INFO)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createSuccess(Icons.ALL.album_mdi())
                                        .circle()
                                        .setSize(ButtonSize.SMALL)
                                        .setButtonType(StyleType.SUCCESS)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createWarning(Icons.ALL.calendar_weekend_mdi())
                                        .circle()
                                        .setSize(ButtonSize.SMALL)
                                        .setButtonType(StyleType.WARNING)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createDanger(Icons.ALL.airplay_mdi())
                                        .circle()
                                        .setSize(ButtonSize.SMALL)
                                        .setButtonType(StyleType.DANGER)
                                        .style().setMargin(px.of(5))))
                ...
                .appendChild(Row.create()
                        .addColumn(Column.span1()
                                .appendChild(Button.create(Icons.ALL.adjust_mdi())
                                        .circle()
                                        .setSize(ButtonSize.LARGE)
                                        .setButtonType(StyleType.DEFAULT)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createPrimary(Icons.ALL.outlook_mdi())
                                        .circle()
                                        .setSize(ButtonSize.LARGE)
                                        .setButtonType(StyleType.PRIMARY)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createInfo(Icons.ALL.apps_mdi())
                                        .circle()
                                        .setSize(ButtonSize.LARGE)
                                        .setButtonType(StyleType.INFO)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createSuccess(Icons.ALL.artist_mdi())
                                        .circle()
                                        .setSize(ButtonSize.LARGE)
                                        .setButtonType(StyleType.SUCCESS)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createWarning(Icons.ALL.assistant_mdi())
                                        .circle()
                                        .setSize(ButtonSize.LARGE)
                                        .setButtonType(StyleType.WARNING)
                                        .style().setMargin(px.of(5))))
                        .addColumn(Column.span1()
                                .appendChild(Button.createDanger(Icons.ALL.compass_mdi())
                                        .circle()
                                        .setSize(ButtonSize.LARGE)
                                        .setButtonType(StyleType.DANGER)
                                        .style().setMargin(px.of(5))))
