...
public abstract class TempValueBox<T extends TempValueBox<T, E, V>, E extends HTMLElement, V> extends TempBasicFormElement<T, V> implements
    ...
    public TempValueBox(String type, String label) {
        init((T) this);
    ...
    public T clear() {
        clearValue();
        autoValidate();
        onClearHandlers.forEach(handler -> handler.accept((T) TempValueBox.this));
        return (T) this;
    }
