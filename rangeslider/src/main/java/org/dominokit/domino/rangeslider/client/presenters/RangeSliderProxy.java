package org.dominokit.domino.rangeslider.client.presenters;
...
@PresenterProxy
@AutoRoute(token = "components/range-slider")
@AutoReveal
@Slot(IsLayout.Slots.CONTENT)
@DependsOn(@EventsGroup(LayoutEvent.class))
@Singleton
public class RangeSliderProxy extends ComponentCasePresenter<RangeSliderView> {
}