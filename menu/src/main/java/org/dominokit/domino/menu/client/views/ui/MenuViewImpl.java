...
public class MenuViewImpl extends BaseDemoView<HTMLDivElement> implements MenuView {
    ...
    protected HTMLDivElement init() {
        ...
        menuItemsGroup();
        element.appendChild(CodeCard.createLazyCodeCard(CodeResource.INSTANCE.menuItemsGroup()));
        ...
        multipleTargets();
        element.appendChild(CodeCard.createLazyCodeCard(CodeResource.INSTANCE.multipleTargets()));
    ...
    @SampleMethod
    private void menuItemsGroup() {
        element
                .appendChild(Card.create("MENU ITEMS GROUPS", "Simple menu items with addons and description")
                        .setCollapsible(true)
                        .appendChild(Row.create()
                                .appendChild(Column
                                        .span4()
                                        .appendChild(Menu.<String>create()
                                                .addCss(dui_w_full)
                                                .appendChild(MenuItemsGroup.<String>create()
                                                        .withHeader((parent, self) -> self
                                                                .setTitle("File")
                                                                .appendChild(PrefixAddOn.of(Icons.file()))
                                                        )
                                                        .appendChild(MenuItem.<String>create("New ...")
                                                                .setKey("new-key")
                                                                .withValue("new-value")
                                                        ...
                                                        .appendChild(MenuItem.<String>create("Save")
                                                                .setKey("save-key")
                                                                .withValue("save-value")
                                                                .appendChild(PrefixAddOn.of(Icons.content_save_outline().addCss(dui_font_size_5)))
                                                        )
                                                        .appendChild(MenuItem.<String>create("Close")
                                                                .setKey("close-key")
                                                                .withValue("close-value")
                                                ...
                                                .appendChild(MenuItemsGroup.<String>create()
                                                        .withHeader((parent, self) -> self
                                                                .setTitle("Project")
                                                                .appendChild(PrefixAddOn.of(Icons.office_building()))
                                                        )
                                                        .appendChild(MenuItem.<String>create("Project structure")
                                                                .setKey("structure-key")
                                                                .withValue("structure-value")
    ...
    @SampleMethod
    private void multipleTargets() {

        Menu<String> dropMenu = Menu.<String>create()
                .setIcon(Icons.file())
                .setTitle("Files")
                .setContextMenu(true)
                .setDropDirection(new TopMiddleDropDirection())
        ...
        CompositeCssClass menuTargetCss = CompositeCssClass.of(
                dui_h_12,
                dui_w_full,
                dui_border,
                dui_border_2px,
        ...
        this.element
                .appendChild(Card.create("MULTIPLE TARGETS", "Use the same menu with multiple targets.")
                        .setCollapsible(true)
                        .appendChild(Row.create()
                                .span3(div()
