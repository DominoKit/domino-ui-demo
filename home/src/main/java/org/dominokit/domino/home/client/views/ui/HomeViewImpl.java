...
public class HomeViewImpl extends BaseDemoView<HTMLDivElement> implements HomeView {
                                ...
                                .appendChild(spinSelect
                                        .appendChild(SpinItem.create("", DominoElement.of(div().css(Styles.align_center))
                                                ...
                                                .appendChild(Paragraph.create("- Tech Leader / Architect @ Ardan1")
                                                        .styler(style -> style.addCss(Styles.font_12)
                                                                .addCss(ColorScheme.GREY.darker_3().getStyle()))
                                                        .italic())))
                                        .appendChild(SpinItem.create("", DominoElement.of(div().css(Styles.align_center))
    ...
    private void initAuthors() {
        ...
        element.appendChild(Card.create()
                .styler(style -> style
                        .addCss(Color.BLACK.getBackground())
                        .addCss("classy-card"))
                .appendChild(Row.create()
        ...
        element.appendChild(div().add(Row.create()
                .appendChild(Column.span3()
                        .appendChild(Card.create()
                                .styler(style -> style.addCss("demo-nav-card"))
                                .setBodyPadding("0px")
    ...
    private void quickInsight() {
        ...
        element.appendChild(Card.create()
                .styler(style -> style.addCss("home-sections", "gs-background", "demo-docs"))
                .setBodyPadding("0px")
