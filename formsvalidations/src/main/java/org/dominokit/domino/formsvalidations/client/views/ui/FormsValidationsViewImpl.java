...
public class FormsValidationsViewImpl extends ComponentView<HTMLDivElement> implements FormsValidationsView {
    ...
    public void init() {
        ...
        element.appendChild(createCodeCard(CodeResource.helperText()).asElement());
        element.appendChild(iconsCard.asElement());
        element.appendChild(createCodeCard(CodeResource.addons()).asElement());
        element.appendChild(countsCard.asElement());
        element.appendChild(createCodeCard(CodeResource.wordCount()).asElement());
        element.appendChild(validationsCard.asElement());
        element.appendChild(createCodeCard(CodeResource.validations()).asElement());
    }
