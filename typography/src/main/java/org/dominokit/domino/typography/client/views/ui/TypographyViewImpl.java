...
public class TypographyViewImpl extends ComponentView<HTMLDivElement> implements TypographyView {
    ...
    private void lists() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.lists())
        .asElement());
    }
    ...
    private void bodyCopy() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.bodyCopy())
                .asElement());
    }
    ...
    private void heading() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.heading())
                .asElement());
    }
    ...
    private void textStyles() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.textStyles())
                .asElement());
    }
    ...
    private void blockqoute() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.blockqoute())
                .asElement());
    }
}