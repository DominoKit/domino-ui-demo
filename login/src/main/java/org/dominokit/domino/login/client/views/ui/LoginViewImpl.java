                ...
                .appendChild(Column.span4()
                        ...
                        .appendChild(Card.create("LOGIN")
                                ...
                                .appendChild(TextBox.password("Password")
                                        .setRequired(true)
                                        .setAutoValidation(true))
                                .appendChild(Button.create(Icons.ALL.lock_open_mdi())
                ...
                .appendChild(Column.span4()
                        ...
                        .appendChild(Card.create("LOGIN")
                                ...
                                .appendChild(TextBox.create("User name")
                                        ...
                                        .setAutoValidation(true))
                                .appendChild(TextBox.password("Password")
                                        .addLeftAddOn(Icons.ALL.security_mdi())
                                        .setRequired(true)
                                        .setAutoValidation(true))
                                .appendChild(CheckBox.create("Remember me")
                                        .style().addCss(Styles.m_l_15))
                                .appendChild(Button.create(Icons.ALL.lock_open_mdi())
                                        .setBackground(Color.THEME)
                                        .setContent("Login")
                                        .block())
                ...
                .appendChild(Column.span4()
                        ...
                        .appendChild(Card.create("LOGIN")
                                ...
                                .appendChild(CheckBox.create("Remember me")
                                        .style().addCss(Styles.m_l_15))
                                .appendChild(div()
                                        .add(Button.create(Icons.ALL.lock_open_mdi())
                                                .setBackground(Color.THEME)
                                                .setContent("Login")
                        ...
                        .appendChild(Card.create()
                                ...
                                .appendChild(DominoElement.of(div().css(Styles.padding_20))
                                        ...
                                        .appendChild(TextBox.password("Password")
                                                .setRequired(true)
                                                .setAutoValidation(true))
                                        .appendChild(Button.createSuccess(Icons.ALL.lock_open_mdi())
                                                .setContent("Login")
                                                .block())
                                )
