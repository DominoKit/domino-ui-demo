package org.dominokit.domino.checktree.client.presenters;
...
@PresenterProxy
@AutoRoute(token = "components/check-tree")
@AutoReveal
@Slot(IsLayout.Slots.CONTENT)
@DependsOn(@EventsGroup(LayoutEvent.class))
public class CheckTreeProxy extends ComponentCasePresenter<CheckTreeView> {
