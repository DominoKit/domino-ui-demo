package org.dominokit.domino.emptystate.client.presenters;
...
@PresenterProxy
@AutoRoute(token = "components/emptystate")
@AutoReveal
@Slot(IsLayout.Slots.CONTENT)
@DependsOn(@EventsGroup(LayoutEvent.class))
public class EmptyStateProxy extends ComponentCasePresenter<EmptyStateView> {
}