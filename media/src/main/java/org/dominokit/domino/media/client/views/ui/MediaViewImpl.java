    ...
    private void defaultMedia() {
        element.appendChild(Card.create("DEFAULT MEDIA", "The default media displays a media object (images, video, audio) to the left or right of a content block.")
                .appendChild(MediaObject.create()
                        ...
                        .setLeftMedia(a()
                                .appendChild(img("https://picsum.photos/seed/0001/64/64")
                                        .addCss(dui_w_16, dui_h_16)))
                        .appendChild(text(SAMPLE_TEXT)))
                .appendChild(MediaObject.create()
                        .setHeader("Media heading")
                        .setLeftMedia(a()
                                .appendChild(img("https://picsum.photos/seed/0002/64/64")
                                        .addCss(dui_w_16, dui_h_16)))
                        .appendChild(text(SAMPLE_TEXT))
                        .appendChild(MediaObject.create()
                                .setHeader("Media heading")
                                .setLeftMedia(a()
                                        .appendChild(img("https://picsum.photos/seed/0003/64/64")
                                                .addCss(dui_w_16, dui_h_16)))
                                .appendChild(text(SAMPLE_TEXT))))
                .appendChild(MediaObject.create()
                        .setHeader("Media heading")
                        .setRightMedia(a()
                                .appendChild(img("https://picsum.photos/seed/0004/64/64")
                                        .addCss(dui_w_16, dui_h_16)))
                        .appendChild(text(SAMPLE_TEXT)))
                .appendChild(MediaObject.create()
                        .setHeader("Media heading")
                        .setRightMedia(a()
                                .appendChild(img("https://picsum.photos/seed/0005/64/64")
                                        .addCss(dui_w_16, dui_h_16)))
                        .setLeftMedia(a()
                                .appendChild(img("https://picsum.photos/seed/0006/64/64")
                                        .addCss(dui_w_16, dui_h_16)))
                        .appendChild(text(SAMPLE_TEXT)))
                );
    ...
    private void mediaAlignment() {
        ...
        element.appendChild(Card.create("MEDIA ALIGNMENT","The images or other media can be aligned top, middle, or bottom. The default is top aligned.")
                .appendChild(MediaObject.create()
                        .setHeader("Media heading")
                        .setLeftMedia(a()
                                .appendChild(img("https://picsum.photos/seed/0007/64/64")
                ...
                .appendChild(MediaObject.create()
                        .setHeader("Media heading")
                        .setLeftMedia(a()
                                .appendChild(img("https://picsum.photos/seed/0008/64/64")
                                        .addCss(dui_w_16, dui_h_16, dui_rounded_full)))
                ...
                .appendChild(MediaObject.create()
                        .setHeader("Media heading")
                        .setLeftMedia(a()
                                .appendChild(img("https://picsum.photos/seed/0009/64/64")
                                        .addCss(dui_w_16, dui_h_16, dui_rounded_full)))
