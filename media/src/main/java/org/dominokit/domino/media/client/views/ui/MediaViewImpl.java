...
public class MediaViewImpl extends ComponentView<HTMLDivElement> implements MediaView {
    ...
    private void defaultMedia() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.defaultMedia()).asElement());
    }
    ...
    private void mediaAlignment() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.mediaAlignment()).asElement());
    }
}