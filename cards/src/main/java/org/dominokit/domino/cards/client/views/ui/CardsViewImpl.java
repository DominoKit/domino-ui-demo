...
public class CardsViewImpl extends ComponentView<HTMLDivElement> implements CardsView{
    ...
    private void cardsWithHeaders() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.cardsWithHeaders()).asElement());
    }
    ...
    private void coloredCards() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.coloredCards()).asElement());
    }
    ...
    private void collapsibleCards() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.collapsibleCards()).asElement());
    }
    ...
    private void noHeaderCards() {
        ...
        element.appendChild(createCodeCard(CodeResource.INSTANCE.noHeaderCards()).asElement());
    }
}